...
const RULES: [AppleCategory, RegExp][] = [
  ...
  ['modulos',     /modulo|module|\bmod\b|pantalla|screen|incell|oled|lcd|display/i],
  ['baterias',    /bater[ií]|battery|tag.?on.?bat/i],
  ['camaras',     /camara|camera|lente|lens|tag.?on.?cam/i],
  ['cristales',   /vidrio|cristal|glass|lente.?trasero/i],
  ['flex',        /flex|bot[oó]n|button|carga.?inal[aá]mbrica|wireless|charging/i],
  ['parlantes',   /parlante|speaker|audio|buzzer|aud[ií]fono|earpiece/i],
  ['sensores',    /sensor|proximidad|proximity|face.?id|touch.?id|huella|fingerprint/i],
